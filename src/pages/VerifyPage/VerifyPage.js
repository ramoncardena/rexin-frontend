...
class VerifyPage extends Component {
    ...
    render() {
        const { t } = this.props
        const { verified, result, error} = this.state
        ...
        return (
            <div>
                ...
                <PageContainer>
                    <Title> { t('Verify_Title') } </Title>
                    <Text> You landed in this page because you requested an account. Click the following button to verify your account:</Text>
                    <VerifyButton 
                        disabled={false} 
